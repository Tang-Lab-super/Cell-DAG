...
plt.savefig(f"{save_folder_cluster}/1.spatial_cluster.png", dpi=600)
...
# plt.savefig(f"{save_folder_cluster}/2.assess_start_cluster_plot.png", dpi=600)
...
fig = plt.figure(figsize=(5, 5))
plt.subplot(1, 1, 1)
sc.pl.embedding(st_data_use, basis="spatial", color="ptime",size=15, s=20, show=False, title='ptime')
plt.savefig(f"{save_folder_trajectory}/3.spatial_ptime.pdf")
