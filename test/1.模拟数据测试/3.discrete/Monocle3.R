...
# cds <- cluster_cells(cds = cds, reduction_method = "UMAP", k=30, cluster_method="leiden", resolution=0.001, num_iter=2)

cds <- preprocess_cds(cds, method = "PCA")
cds <- reduce_dimension(cds, reduction_method = "UMAP")
cds <- cluster_cells(cds, reduction_method = "UMAP")

# Error in leidenbase::leiden_find_partition(g, partition_type = partition_type,  :
